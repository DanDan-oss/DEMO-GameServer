...
const uint32_t TableStruct_msg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::pb::SyncPid, _impl_.playid_),
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::pb::Player, _impl_.playid_),
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::pb::Position, _impl_.posx_),
  PROTOBUF_FIELD_OFFSET(::pb::Position, _impl_.posy_),
  PROTOBUF_FIELD_OFFSET(::pb::Position, _impl_.posz_),
  PROTOBUF_FIELD_OFFSET(::pb::Position, _impl_.posv_),
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::pb::MovePackege, _impl_.pos_),
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::pb::BroadCast, _impl_.playid_),
  PROTOBUF_FIELD_OFFSET(::pb::BroadCast, _impl_.type_),
...
SyncPid::SyncPid(const SyncPid& from)
  ...
  _this->_impl_.playid_ = from._impl_.playid_;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _impl_.playid_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SyncPid::_InternalSerialize(
  ...
  // int32 PlayID = 1;
  if (this->_internal_playid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(1, this->_internal_playid(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:pb.SyncPid)
  ...
  // int32 PlayID = 1;
  if (this->_internal_playid() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_playid());
  }
...
void SyncPid::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_playid() != 0) {
    _this->_internal_set_playid(from._internal_playid());
  }
...
void SyncPid::InternalSwap(SyncPid* other) {
  ...
  swap(_impl_.playid_, other->_impl_.playid_);
}
...
void Player::InternalSwap(Player* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Player, _impl_.playid_)
      + sizeof(Player::_impl_.playid_)
...
Position::Position(const Position& from)
  ...
  ::memcpy(&_impl_.posx_, &from._impl_.posx_,
    ...
    reinterpret_cast<char*>(&_impl_.posx_)) + sizeof(_impl_.bloodvalue_));
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 37)) {
          _impl_.posv_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Position::_InternalSerialize(
  ...
  // float posV = 4;
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_posv = this->_internal_posv();
  uint32_t raw_posv;
  memcpy(&raw_posv, &tmp_posv, sizeof(tmp_posv));
  if (raw_posv != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(4, this->_internal_posv(), target);
  }
...
void Position::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  static_assert(sizeof(uint32_t) == sizeof(float), "Code assumes uint32_t and float are the same size.");
  float tmp_posv = from._internal_posv();
  uint32_t raw_posv;
  memcpy(&raw_posv, &tmp_posv, sizeof(tmp_posv));
  if (raw_posv != 0) {
    _this->_internal_set_posv(from._internal_posv());
  }
...
class MovePackege::_Internal {
 public:
  static const ::pb::Position& pos(const MovePackege* msg);
};

const ::pb::Position&
MovePackege::_Internal::pos(const MovePackege* msg) {
  return *msg->_impl_.pos_;
}
...
void MovePackege::InternalSwap(MovePackege* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(MovePackege, _impl_.pos_)>(
          reinterpret_cast<char*>(&_impl_.pos_),
          reinterpret_cast<char*>(&other->_impl_.pos_));
}
...
BroadCast::BroadCast(const BroadCast& from)
  ...
  ::memcpy(&_impl_.playid_, &from._impl_.playid_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.type_) -
    reinterpret_cast<char*>(&_impl_.playid_)) + sizeof(_impl_.type_));
  clear_has_data();
...
// @@protoc_insertion_point(message_clear_start:pb.BroadCast)
  ...
  _impl_.username_.ClearToEmpty();
  ::memset(&_impl_.playid_, 0, static_cast<size_t>(
...
void BroadCast::InternalSwap(BroadCast* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(BroadCast, _impl_.type_)
      + sizeof(BroadCast::_impl_.type_)
      - PROTOBUF_FIELD_OFFSET(BroadCast, _impl_.playid_)>(
          reinterpret_cast<char*>(&_impl_.playid_),
          reinterpret_cast<char*>(&other->_impl_.playid_));
